...
namespace InstaSharper.Helpers
{
    internal class UriCreator
    {
        ...
        public static Uri GetExploreUri(string maxId = null, string rankToken = null)
        {
            ...
            var query = $"is_prefetch=false&is_from_promote=true&timezone_offset={InstaApiConstants.TIMEZONE_OFFSET}&supported_capabilities_new={JsonConvert.SerializeObject(InstaApiConstants.SupportedCapabilities)}";
        ...
        public static Uri GetPresenceUri(string signedKey)
        {
            ...
            var query = $"{"signed_body"}={signedBody}&{InstaApiConstants.HEADER_IG_SIGNATURE_KEY_VERSION}={InstaApiConstants.IG_SIGNATURE_KEY_VERSION}";
            var uriBuilder = new UriBuilder(instaUri) { Query = query };
            return uriBuilder.Uri;
        }
