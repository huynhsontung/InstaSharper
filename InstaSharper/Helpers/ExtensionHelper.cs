...
namespace InstaSharper.Helpers
{
    ...
    {
//        public static string GenerateUserAgent(this AndroidDevice deviceInfo, ApiVersion apiVersion)
//        {
//            if (deviceInfo == null)
//                return InstaApiConstants.USER_AGENT_DEFAULT;
//            if (deviceInfo.AndroidVersion == null)
//                deviceInfo.AndroidVersion = AndroidVersion.GetRandomAndriodVersion();
//
//            return string.Format(InstaApiConstants.USER_AGENT, deviceInfo.Dpi+"dpi", deviceInfo.ScreenResolution, deviceInfo.HardwareManufacturer,
//                deviceInfo.HardwareModel, deviceInfo.FirmwareBrand, deviceInfo.HardwareModel,
//                apiVersion.AppVersion, deviceInfo.AndroidVersion.APILevel,
//                deviceInfo.AndroidVersion.VersionNumber, apiVersion.VersionCode);
//        }
...
//              deviceInfo.AndroidVersion.VersionNumber,deviceInfo.HardwareModel,
