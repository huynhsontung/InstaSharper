...
namespace InstaSharper.Classes.ResponseWrappers.Highlight
{
    ...
    public class InstaHighlightCoverMediaResponse
    {
        ...
        public BaseMediaResponse CroppedImageVersion { get; set; }
        [JsonProperty("crop_rect")]
        public float[] CropRect { get; set; }
        [JsonProperty("media_id")]
        public string MediaId { get; set; }
        [JsonProperty("full_image_version")]
        public BaseMediaResponse FullImageVersion { get; set; }
    }
}
