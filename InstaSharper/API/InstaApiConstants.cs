...
namespace InstaSharper.API
{
    ...
    internal static class InstaApiConstants
    {
        ...
        public const string DIRECT_UPLOAD_PHOTO = INSTAGRAM_URL + "/rupload_igphoto/{0}";
        /// <summary>
        /// post data:
        ...
        public const string GET_DIRECT_THREAD_FROM_USERS = API_SUFFIX + "/direct_v2/threads/get_by_participants/?recipient_users=[{0}]";
